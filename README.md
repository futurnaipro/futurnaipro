...
<p align="center">
  Building intelligent software, end to end — from training machine learning models
  to production-ready APIs and user-facing dashboards.
</p>
...
- Software Engineering graduate with a **Master's in Data Science & Artificial Intelligence**
- I build things from the ground up — machine learning models, backend APIs, and the dashboards that sit on top of them
- Currently open to **full-time positions, freelance projects, and collaborations**
- Based in Algeria · Speak Arabic, French, and English
...
![AraBERT/NLP](https://img.shields.io/badge/AraBERT%20%C2%B7%20NLP-4B4B4B?style=flat-square)
